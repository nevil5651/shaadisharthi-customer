...
const FaEye = lazy(() =>
  import("react-icons/fa").then((mod) => ({ default: mod.FaEye }))
);
const FaEyeSlash = lazy(() =>
  import("react-icons/fa").then((mod) => ({ default: mod.FaEyeSlash }))
);
...
const FaApple = lazy(() =>
  import("react-icons/fa").then((mod) => ({ default: mod.FaApple }))
);
...
const IconFallback = () => (
  <span className="inline-block w-4 h-4 bg-gray-200 dark:bg-gray-600 animate-pulse rounded"></span>
);
...
export default function Login() {
  ...
  const onSubmit = async (data: LoginFormInputs) => {
    ...
    try {
      ...
      // Catch network or parsing errors and display a generic message
      ...
      <Suspense fallback={<AuthCardFallback />}>
        ...
        >
          <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            {apiError && (
              <div
                className="p-3 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-900 dark:bg-opacity-20 dark:text-red-300"
                role="alert"
              >
                {apiError}
              </div>
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between items-center mb-4 sm:mb-6 space-y-3 sm:space-y-0">
              ...
              <Link
                ...
                className="text-pink-500 hover:text-pink-700 dark:text-pink-400 dark:hover:text-pink-300 text-xs sm:text-sm"
              >
                Forgot password?
              </Link>
            </div>
            ...
            <div className="flex items-center my-4 sm:my-6">
              ...
              <span className="mx-4 text-gray-500 dark:text-gray-400 text-xs sm:text-sm">
                or continue with
              </span>
              <div className="border-t border-gray-300 flex-grow dark:border-gray-600"></div>
            </div>
            ...
            <div className="flex justify-center space-x-4 mb-4 sm:mb-6">
              <button
                type="button"
                className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-blue-600 hover:bg-gray-200 transition duration-150 ease-in-out dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-blue-400"
              >
                <Suspense fallback={<IconFallback />}>
                  <FaFacebookF />
                </Suspense>
              ...
              <button
                type="button"
                className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-red-600 hover:bg-gray-200 transition duration-150 ease-in-out dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-red-400"
              >
                <Suspense fallback={<IconFallback />}>
                  <FaGoogle />
                </Suspense>
              ...
              <button
                type="button"
                className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-black hover:bg-gray-200 transition duration-150 ease-in-out dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white"
              >
                <Suspense fallback={<IconFallback />}>
                  <FaApple />
                </Suspense>
            ...
            <div className="text-center text-gray-700 dark:text-gray-300 text-xs sm:text-sm">
              ...
              <Link
                href="/verify-email"
                className="text-pink-500 font-medium hover:underline dark:text-pink-400"
              >
                Register now
              </Link>
            </div>
