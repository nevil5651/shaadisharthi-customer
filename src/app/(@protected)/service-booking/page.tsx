  ...
  return (
    <main className="bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl overflow-hidden max-w-3xl mx-auto shadow-[0_10px_25px_-5px_rgba(0,0,0,0.1)] border border-gray-100">

          
          {/* Service Header */}
          <div className="bg-gradient-to-r text-center mb-4 from-primary/5 to-secondary/5 p-6 border-b border-gray-100">
                  <h1 className="text-3xl font-bold font-serif">  Book {service.name} </h1>
                  <p className="opacity-90">Complete your booking details below</p>
          </div>
          ...
          <div className="bg-gradient-to-r from-primary/5 to-secondary/5 p-6 border-b border-gray-100">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="font-medium">{service.businessName}</p>
              </div>
              <div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
            ...
            <div>
              ...
              {errors.service_price && (
                <p className="mt-1 text-sm text-red-600">{errors.service_price.message}</p>
              )}
            </div>

            {/* Event Details */}
            <div>
              <label htmlFor="event_address" className="block text-sm font-medium text-gray-700 mb-1">
              ...
              {errors.event_address && (
                <p className="mt-1 text-sm text-red-600">{errors.event_address.message}</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                {errors.event_start_date && (
                  <p className="mt-1 text-sm text-red-600">{errors.event_start_date.message}</p>
                )}
              </div>
              <div>
...
const ServiceBookingPage = () => {
  return (
    <Suspense fallback={<div className="text-center py-8">Loading Booking Page...</div>}>
      <ServiceBookingForm />
    </Suspense>
  );
};
