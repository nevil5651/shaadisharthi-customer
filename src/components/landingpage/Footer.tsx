...
const Footer = () => {
  ...
  return (
    <footer className="bg-white dark:bg-gray-950 text-white pt-12 pb-6">
  ...
  <a href="#" className="text-gray-600 dark:text-gray-400hover:text-primary dark:hover:text-pink-400 transition duration-300" aria-label="Instagram">
  ...
  <a href="#" className="text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-pink-400 transition duration-300" aria-label="YouTube">
    <FontAwesomeIcon icon={faYoutube} className="text-white" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/services?category=Photographers" className="text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-pink-400 transition duration-300">Photography</Link></li>
              <li><Link href="/services?category=Venues" className="text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-pink-400 transition duration-300">Venues</Link></li>
              <li><Link href="/services?category=Catering" className="text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-pink-400 transition duration-300">Catering</Link></li>
              <li><Link href="/services?category=Decoration" className="text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-pink-400 transition duration-300">Decorations</Link></li>
              <li><Link href="/services?category=WeddingPlanner" className="text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-pink-400 transition duration-300">Wedding Planning</Link></li>
            </ul>
          </div>
          <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex">
              <input type="email" placeholder="Your email" {...register('email')} className="px-4 py-2 rounded-l-lg bg-gray-600 dark:bg-gray-700 focus:outline-none text-white dark:text-gray-200 w-full" />
        ...
        <div className="border-t border-gray-800 dark:border-gray-700 mt-8 pt-6 text-center text-gray-600 dark:text-gray-400">
